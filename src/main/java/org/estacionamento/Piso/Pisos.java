...
public class Pisos implements IPisos {
    ...
    public boolean estacionarVeiculo(Veiculos veiculo) {
        if (veiculo.getTipo(veiculo).equals("Carro")) {
        ...
        } else if (veiculo.getTipo(veiculo).equals("Moto")) {
            if (vagas.getMoto() > 0) {
    ...
    public boolean sairEstacionamento(Veiculos veiculo) {
        ...
        } else if (veiculo.getTipo(veiculo).equals("Van")) {
        ...
        } else if (veiculo.getTipo(veiculo).equals("Caminhao")) {
            if (vagas.getGrande() < 0) {
                vagas.setGrande(vagas.getGrande() + 1);
